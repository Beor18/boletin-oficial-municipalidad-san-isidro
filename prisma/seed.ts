...
• Que resulta necesario instruir a las áreas municipales intervinientes (Rentas/Recaudación, Catastro/Registros, Servicios Públicos/Obras, Tesorería, Contaduría e Inspección –según corresponda–) para la puesta en marcha de la emisión, liquidación, cobro, control y registración de la tasa en el ejercicio 2026, conforme el régimen aprobado;`,
  ...
  const resoluciones = [
    ...
    },
    {
      ...
      numero: 1755,
      anio: 2025,
      titulo: "DISPONIENDO EMERGENCIA VIAL",
      visto: "...",
      considerando: "...",
      articulos: JSON.stringify([
        "ARTÍCULO 1º DECLÁRASE LA EMERGENCIA VIAL en el ámbito de la Municipalidad de San Isidro, respecto de los caminos municipales y de aquellos tramos de rutas provinciales comprendidos dentro del ejido y zonas rurales de la localidad, atento al estado crítico de transitabilidad verificado.",
        "ARTÍCULO 2º ESTABLÉCESE que la Emergencia Vial tendrá una vigencia inicial de noventa (90) días, contados a partir de la fecha de la presente, pudiendo ser prorrogada mediante resolución fundada, de persistir las causas que la motivan.",
        "ARTÍCULO 3º AUTORÍZASE a la Secretaría de Obras y Servicios Públicos a planificar, coordinar y ejecutar con carácter prioritario las tareas de reparación, enripiado, nivelación, desagote, mantenimiento y cualquier otra intervención necesaria para restablecer la transitabilidad de los caminos afectados.",
        "ARTÍCULO 4º DISPÓNESE la afectación prioritaria de los recursos humanos, materiales y financieros disponibles, quedando facultadas las áreas competentes a instrumentar los procedimientos administrativos que resulten necesarios, conforme la normativa vigente.",
        "ARTÍCULO 5º INSTRÚYESE a las Secretarías y dependencias municipales a prestar la colaboración que resulte requerida para el cumplimiento de la presente resolución.",
        "ARTÍCULO 6º COMUNÍQUESE a las Secretarías/Áreas pertinentes y al Honorable Concejo Deliberante. REGÍSTRESE, publíquese si correspondiere y ARCHÍVESE oportunamente.",
      ]),
      cierre: null,
    },
    {
